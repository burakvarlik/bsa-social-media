...
"""
    ...
    resp = client.chat.completions.create(
        model="gpt-4o",
        messages=[
            {"role": "system", "content": "Sen BSA için editorial bir içerik direktörüsün. Her zaman talep edilen tam sayıda post üretirsin."},
...
def generate_photo(prompt, idx):
    ...
    print(f"  [DALL-E {idx+1}] tamam ({len(img_bytes)//1024} KB)", flush=True)
